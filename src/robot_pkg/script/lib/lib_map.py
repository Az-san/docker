...
class LibMap:
    ...
    def getMapOriginMeter(
        ...
        origin_meter_x = self.sub_map_data.info.height * self.sub_map_data.info.resolution + self.sub_map_data.info.origin.position.y
        origin_meter_y = self.sub_map_data.info.width * self.sub_map_data.info.resolution + self.sub_map_data.info.origin.position.x
