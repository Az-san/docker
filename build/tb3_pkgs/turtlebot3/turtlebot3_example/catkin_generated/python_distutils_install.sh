...
echo_and_run cd "/root/ros1_ws/src/tb3_pkgs/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/ros1_ws/src/tb3_pkgs/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/root/ros1_ws/build/tb3_pkgs/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
